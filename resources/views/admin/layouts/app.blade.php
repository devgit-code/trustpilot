...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ request()->url() == url('/admin/categories') ? '' : 'collapsed' }}" href="{{ url('/admin/categories') }}">
          <i class="fa fa-comments"></i>&nbsp;
      ...
      <li class="nav-item">
        <a class="nav-link {{ request()->url() == url('/admin/companies') ? '' : 'collapsed' }}" href="{{ url('/admin/companies') }}">
          <i class="fa fa-comments"></i>&nbsp;
          <span>Companies</span>
        </a>
      </li>
